// WebRTC Video Conference Application - Client Side
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   // Function to receive video from other participants
   ...
   // Function to handle existing participants and setup your own video
   function onExistingParticipants(userid, existingUsers) {
       ...
       name.appendChild(document.createTextNode(userName + ' (You)'));
       div.appendChild(video);
       div.appendChild(name);
       divMeetingRoom.appendChild(div);
   ...
   // Function to process SDP answers from other participants
